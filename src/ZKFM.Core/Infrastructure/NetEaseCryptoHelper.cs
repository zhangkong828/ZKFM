...
{
    public class NetEaseCryptoHelper
    {
        // 固定值
        ...
        public static EncryptData EncryptedRequest(String text)
        {
            // key
            ...
            return new EncryptData() { @params = encText, encSecKey = encSecKey };
        }
        ...
        /// <returns>加密后的数据</returns>
        private static String AesEncrypt(String data, String secKey, String iv)
        {
